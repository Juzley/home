...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {navbarState: a, accordionState: b};
	});
var _user$project$Main$AccordionMsg = function (a) {
	return {ctor: 'AccordionMsg', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Accordion$subscriptions, model.accordionState, _user$project$Main$AccordionMsg);
};
var _user$project$Main$NavbarMsg = function (a) {
	return {ctor: 'NavbarMsg', _0: a};
};
var _user$project$Main$init = function () {
	var _p0 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$Main$NavbarMsg);
	var navbarState = _p0._0;
	var navbarCmd = _p0._1;
	return {
		ctor: '_Tuple2',
		_0: {navbarState: navbarState, accordionState: _rundis$elm_bootstrap$Bootstrap_Accordion$initialState},
		_1: navbarCmd
	};
}();
		...
		A2(
			_rundis$elm_bootstrap$Bootstrap_Navbar$items,
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('#rooms'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('#people'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('People'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			...
			A3(
				...
				_rundis$elm_bootstrap$Bootstrap_Navbar$info(
...
var _user$project$Main$sendCommand = function (cmd) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'api/v1/rooms/livingroom/command/', cmd);
	var request = A3(
		_elm_lang$http$Http$post,
		url,
		_elm_lang$http$Http$emptyBody,
		_elm_lang$core$Json_Decode$succeed(''));
	return A2(_elm_lang$http$Http$send, _user$project$Main$PostResult, request);
};
		...
		switch (_p1.ctor) {
			case 'LampsOn':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$sendCommand('lamps_on')
				};
			case 'LampsOff':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$sendCommand('lamps_off')
				};
			case 'PostResult':
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{accordionState: _p1._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$LampsOff = {ctor: 'LampsOff'};
var _user$project$Main$LampsOn = {ctor: 'LampsOn'};
var _user$project$Main$livingRoomPage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_rundis$elm_bootstrap$Bootstrap_Button$button,
				{
					...
					_1: {
						ctor: '::',
						_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$LampsOn),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Lamps On'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_rundis$elm_bootstrap$Bootstrap_Button$button,
					{
						...
						_1: {
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(_user$project$Main$LampsOff),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Lamps Off'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$roomsAccordion = function (model) {
	return A2(
		...
		A2(
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Accordion$card(
					{
						...
						header: A2(
							...
							A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Living Room'),
									_1: {ctor: '[]'}
								})),
						blocks: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Main$livingRoomPage(model),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
					...
					_0: _rundis$elm_bootstrap$Bootstrap_Accordion$card(
						{
							...
							header: A2(
								...
								A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Bedroom'),
										_1: {ctor: '[]'}
									})),
							blocks: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Add bedroom stuff'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
			...
			_rundis$elm_bootstrap$Bootstrap_Accordion$withAnimation(
				_rundis$elm_bootstrap$Bootstrap_Accordion$config(_user$project$Main$AccordionMsg))));
};
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$classList(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'container-fluid', _1: true},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'container-accordion', _1: true},
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
					...
					{
						ctor: '::',
						_0: _user$project$Main$roomsAccordion(model),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Bootstrap.Navbar.Visibility":{"args":[],"tags":{"AnimatingDown":[],"StartDown":[],"StartUp":[],"AnimatingUp":[],"Hidden":[],"Shown":[]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Bootstrap.Accordion.State":{"args":[],"tags":{"State":["Dict.Dict String Bootstrap.Accordion.CardState"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Bootstrap.Accordion.Visibility":{"args":[],"tags":{"AnimatingDown":[],"StartDown":[],"StartUp":[],"AnimatingUp":[],"Hidden":[],"Shown":[]}},"Main.Msg":{"args":[],"tags":{"LampsOff":[],"NavbarMsg":["Bootstrap.Navbar.State"],"PostResult":["Result.Result Http.Error String"],"LampsOn":[],"AccordionMsg":["Bootstrap.Accordion.State"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Bootstrap.Navbar.DropdownStatus":{"args":[],"tags":{"ListenClicks":[],"Closed":[],"Open":[]}},"Bootstrap.Navbar.State":{"args":[],"tags":{"State":["Bootstrap.Navbar.VisibilityState"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Bootstrap.Navbar.VisibilityState":{"args":[],"type":"{ visibility : Bootstrap.Navbar.Visibility , height : Maybe.Maybe Float , windowSize : Maybe.Maybe Window.Size , dropdowns : Dict.Dict String Bootstrap.Navbar.DropdownStatus }"},"Bootstrap.Accordion.CardState":{"args":[],"type":"{ visibility : Bootstrap.Accordion.Visibility , height : Maybe.Maybe Float }"},"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
